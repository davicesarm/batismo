...
export default function Batizado({ batizado }: { batizado: BatizadoType }) {
  ...
  return (
    <div className="border-l-3 border-blue-400 flex flex-col gap-2 text-xs text-neutral-700 relative bg-neutral-100 rounded-xl p-4 shadow-md justify-between">
