...
export default function AdminPage() {
  return (
    <>
      ...
      <main>
        <div className="shadow-md bg-neutral-50 flex flex-col gap-4 border-l-blue-400 border-l-3 mx-auto mt-4 border border-neutral-300 p-2 sm:p-4 rounded-lg max-w-4xl">
          <a
            className="self-center flex items-center gap-1 w-fit text-sm px-2 py-1 rounded-full border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white"
