...
**4. Fluxo Principal**
1. O sistema recupera a lista de todos os casais com status "Ativo".
...
4. O sistema valida se o casal selecionado está disponível na data/horário do batismo.
...
* **5.1 Casal com Impedimento:** Caso o casal selecionado pelo ciclo já esteja em outro compromisso na mesma data, o sistema pula para o próximo casal da lista e repete o passo 4.
* **5.2 Sem Casais Ativos:** Caso não existam casais ativos, o sistema marca o batismo com o status "Pendente de Alocação" e notifica a Secretaria.
