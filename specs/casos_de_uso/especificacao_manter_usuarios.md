...
2. O sistema exibe a lista de usuários cadastrados com seus respectivos perfis.
...
* **4.1 Desativação de Casal:** O Administrador pode alterar o status de um casal para "Inativo" (ex: licença ou saída da pastoral). Usuários inativos não entram na Alocação Automática.
